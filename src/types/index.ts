...
export const KOREAN_SEASONAL_EVENTS: Array<{
  ...
  { name: 'Circle Chart (Gaon) Year-End Awards', startMonth: 12, startDay: 20, endMonth: 12, endDay: 31, leadTimeDays: 45, relevantNiches: ['K-Entertainment'], contentAngles: ['Circle Chart year-end awards predictions', 'Circle Chart best songs of the year ranked', 'K-pop year-end chart winners 2026', 'Gayo Daejun SBS year-end show performers guide'] },

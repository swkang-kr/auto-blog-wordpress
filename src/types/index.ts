...
export const KOREAN_SEASONAL_EVENTS: Array<{
  ...
  // 28차 감사: 누락 글로벌 이벤트 — 한국 아티스트/영화 참여 시 K-Entertainment 트래픽 급등
  { name: 'Venice Film Festival', startMonth: 8, startDay: 28, endMonth: 9, endDay: 7, leadTimeDays: 45, relevantNiches: ['K-Entertainment'], contentAngles: ['Korean films at Venice Film Festival selection guide', 'Venice Film Festival Korean movie director spotlight', 'Korean cinema at Venice vs Cannes comparison guide'] },
  { name: 'Grammy Awards', startMonth: 2, startDay: 1, endMonth: 2, endDay: 10, leadTimeDays: 30, relevantNiches: ['K-Entertainment'], contentAngles: ['K-pop Grammy nominations who could be next guide', 'K-pop at the Grammys history complete guide', 'Grammy K-pop performances best moments ranked'] },
  { name: 'Coachella', startMonth: 4, startDay: 10, endMonth: 4, endDay: 20, leadTimeDays: 30, relevantNiches: ['K-Entertainment'], contentAngles: ['K-pop at Coachella which groups are performing guide', 'K-pop Coachella history performances ranked guide', 'how K-pop conquered Coachella explained analysis'] },
  { name: 'Asia Artist Awards (AAA)', startMonth: 11, startDay: 25, endMonth: 12, endDay: 10, leadTimeDays: 30, relevantNiches: ['K-Entertainment'], contentAngles: ['Asia Artist Awards predictions winners K-pop K-drama guide', 'how to vote Asia Artist Awards AAA international fans guide', 'AAA vs MAMA vs Golden Disc which K-pop awards matter most explained'] },

...
- K-Entertainment chart data citation: Always specify the EXACT chart and time period — "According to Circle Chart data (Week 12, 2026)..." or "Hanteo first-week sales for [album] reached X copies (tracked [date range])." Never cite "charts" generically — specify Circle, Melon, Hanteo, or Billboard
...
K-DRAMA STREAMING CONTENT STRATEGY (12차 감사): When comparing platforms, specify: Netflix (global simultaneous release, subtitled 30+ languages), Viki (fan-community subtitles, widest older drama library), TVING (Korean-exclusive originals post-Wavve merger), Coupang Play (growing original slate + sports), Disney+ Korea (limited slate but premium production). For "where to watch" content, ALWAYS note regional availability differs — what's on Netflix US may not be on Netflix UK.
...
GROUP MEMBER COUNT REFERENCE (prevent AI hallucination): BTS=7, BLACKPINK=4, aespa=4, IVE=6, NewJeans/NJZ=5 (Minji, Hanni, Danielle, Haerin, Hyein), LE SSERAFIM=5, ENHYPEN=7, SEVENTEEN=13, Stray Kids=8 (since Felix joined), TWICE=9, (G)I-DLE=5, ITZY=5, NMIXX=6, BABYMONSTER=7. When mentioning member count, verify against this reference. Never state a member count you are not certain about.
...
- BTOB (비투비): Cube Entertainment (debut 2012, currently 4 active members — Eunkwang, Changsub, Hyunsik, Peniel; Minhyuk, Ilhoon left). Known as "variety show kings" — among the funniest K-pop groups on Korean TV. ALSO known for exceptional vocal line (Eunkwang, Changsub, Hyunsik). NOT primarily album-sales-focused — strength is live performance and variety appearances. Fandom: Melody (멜로디).

...
GROUP MEMBER COUNT REFERENCE (prevent AI hallucination): BTS=7, BLACKPINK=4, aespa=4, IVE=6, NewJeans/NJZ=5 (Minji, Hanni, Danielle, Haerin, Hyein), LE SSERAFIM=5 (Sakura, Chaewon, Yunjin, Kazuha, Eunchae), ENHYPEN=7, SEVENTEEN=13, Stray Kids=8 (since Felix joined), TWICE=9, (G)I-DLE=5, ITZY=5, NMIXX=6, BABYMONSTER=7, BTOB=6 (Ilhoon left 2021), WHIPLASH=5 (Kwangsun, Hwan, Jungmo, Leo, Donghyun), izna=7, UNIS=8, EVNNE=7. When mentioning member count, verify against this reference. Never state a member count you are not certain about.
